...
| <a name="input_custom_kms_arn"></a> [custom\_kms\_arn](#input\_custom\_kms\_arn) | ARN of KMS that will be used for s3 bucket encryption. Will only be used if 'use\_custom\_kms' is true. | `string` | `""` | no |
