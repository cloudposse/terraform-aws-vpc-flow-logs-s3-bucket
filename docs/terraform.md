...
| <a name="input_source_json"></a> [source\_json](#input\_source\_json) | Custom IAM policy document that can optionally be passed and merged with exported document | `string` | `""` | no |
